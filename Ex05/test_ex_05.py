...
class TestTask2(unittest.TestCase):
    ...
    def test_determine_decile_thresholds7(self):
        self.assertIn(self.thresholds[8],[4530,4531,4532,4533,4534,4535,4536])
    
    #Test 16: complete identity with the expected thresholds
    def test_determine_decile_thresholds8(self):
        self.assertEqual(self.thresholds,[2, 8, 20, 39, 72, 142, 330, 968, 4533])
...
class TestTask3(unittest.TestCase):
    ...
    def test_get_prefix_frequencies6(self):
        prefixes = set()
        for (prefix,count) in self.prefix_frequencies:
             prefixes.add(prefix)
